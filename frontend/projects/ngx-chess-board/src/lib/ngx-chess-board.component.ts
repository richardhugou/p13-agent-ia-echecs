import { CdkDragEnd, CdkDragMove, CdkDragStart, DragDropModule } from '@angular/cdk/drag-drop'; // Added DragDropModule
import {
    AfterViewInit,
    Component,
    ElementRef,
...
@Component({
    ...
    imports: [
      CommonModule, // Added
      DragDropModule, // Added
      PiecePromotionModalComponent, // Added
    ]
})
